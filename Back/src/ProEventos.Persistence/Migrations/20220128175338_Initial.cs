    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedeSocias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedeSocias_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RedeSocias_Palestrantes_PalestranteId",
                        column: x => x.PalestranteId,
                        principalTable: "Palestrantes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedeSocias_EventoId",
                table: "RedeSocias",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_RedeSocias_PalestranteId",
                table: "RedeSocias",
                column: "PalestranteId");
        }
